...
<head>
    ...
    <link rel="stylesheet" href="/style/genre/comedy_style.css">
</head>
<body>
    <div id="navigation">
    ...
    <div class="search-page-container">
        <h2 class="category-title">코미디</h2>
        ...
        <div class="movie-grid" id="movieGrid">
            <%
                String apiUrl = "https://api.themoviedb.org/3/discover/movie?with_genres=35&language=ko-KR&page=1";
                ...
                try {
                    ...
                    for (int pageNum = 1; pageNum <= totalPages; pageNum++) {
                        String pageUrl = "https://api.themoviedb.org/3/discover/movie?with_genres=35&language=ko-KR&page=" + pageNum;
                        url = new URL(pageUrl);
