...
<head>
    ...
    <link rel="stylesheet" href="/style/genre/horror_style.css">
</head>
<body>
    <div id="navigation">
    ...
    <div class="search-page-container">
        ...
        <div class="movie-grid" id="movieGrid">
            <%
                String apiUrl = "https://api.themoviedb.org/3/discover/movie?with_genres=27&language=ko-KR&page=1";
                ...
                try {
                    ...
                    for (int pageNum = 1; pageNum <= totalPages; pageNum++) {
                        String pageUrl = "https://api.themoviedb.org/3/discover/movie?with_genres=27&language=ko-KR&page=" + pageNum;
                        url = new URL(pageUrl);
